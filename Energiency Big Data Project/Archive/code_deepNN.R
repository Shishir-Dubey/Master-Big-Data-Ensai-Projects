##########    deep neurenal network    #########################
Grid <-  expand.grid(layer1 =c(2,4), 
                     layer2 =2,
                     layer3 =c(2,4),
                     hidden_dropout=0:1,
                     visible_dropout=0:1)
...
xtr=xtrain
xte=xtest
# fitting the model deep neurenal network
model=deep.nn(xtr,ytr,ctrl)
...
#pred = as.factor(ifelse(predProba[1] > 0.5,"Faillure","Normal"))
